...
const analyzeTicket = async (ticket) => {
  ...
  3. A clearer explanation of the problem and it's root cause and technical context **to help the moderator understand and investigate the issue — but do not provide a solution.** Include useful external links or resources if possible.
